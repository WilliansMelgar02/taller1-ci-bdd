...
Write-Host "    mvn verify                       Unitarias + integracion + BDD + cobertura"
Write-Host "    mvn compile spotbugs:check       Analisis estatico"
Write-Host "    .\correr-performance.ps1         Prueba de carga sobre el portal real"
Write-Host "    java -jar target\portal-clientes.jar   Levanta el portal en :8080"
Write-Host "    mvn verify -Paceptacion          Aceptacion contra http://localhost:8080"
